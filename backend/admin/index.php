      ...
      <div class="navbar-container">
        <div class="collapse navbar-collapse justify-content-end" id="navbar-mobile">
          <ul class="nav navbar-nav">
            <li class="nav-item"><a class="nav-link mr-2 nav-link-label" href="\Nhub\Index.php"><i class="ficon ft-arrow-left"></i></a></li>
...
<button type="submit" class="btn btn-success btn-block btn-lg" name="login"><i class="ft-unlock"></i> Login</button>
<a href="\Nhub\Index.php" class="btn btn-info btn-block btn-lg">Go to Home</a>
</form>
  ...
  <footer class="footer fixed-bottom footer-dark navbar-border navbar-shadow">
    <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
      ...
      <span class="float-md-right d-block d-md-inline-blockd-none d-lg-block">babuje.ng</span>
    </p>
  </footer>
  <!-- BEGIN VENDOR JS-->
